...
{% include gallery id="gallery-foraar" layout="half" caption="Unglærerne fra foråret 2018 - Emil Kirk, Anne Vinternes" %}
...
{% include gallery id="gallery-efteraar" layout="half" caption="Unglærerne fra efteråret 2018 - Channie Urup Jensen og Matthias Yde" %}
